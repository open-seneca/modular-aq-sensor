...
//    while (1);
  ...
  if (myFile) {
    ...
    myFile.println(F("Counter,Millis,gpsUpdated,Date,Time,Latitude,Longitude,Speed,Altitude,Satellites,AccX,AccY,AccZ,Temperature,GyroX,GyroY,GyroZ,nAcc,PM10,PM2.5"));
    myFile.print("Reference");
    myFile.print(","); myFile.print(mtime);
    for (int i=0; i<8; i++) { // no reference GPS data at this point
    ...
    myFile.print(","); myFile.print(0); // no reference values for PM10/PM2.5 at this point
    myFile.print(","); myFile.println(0);
    // close the file:
    myFile.close();
  } else {
  ...
  Serial.println(F("Counter,Millis,gpsUpdated,Date,Time,Latitude,Longitude,Speed,Altitude,Satellites,AccX,AccY,AccZ,Temperature,GyroX,GyroY,GyroZ,nAcc,PM10,PM2.5"));
  ...
  Serial.print(","); Serial.print(n_cali);
  for (int i=0; i<2; i++) { // no reference values for PM10/PM2.5 at this point
    Serial.print(","); Serial.print(0);
  }
  Serial.println();
  digitalWrite(LED, HIGH);
